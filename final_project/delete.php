...
<title>Delete Record</title>
	...
	{
		$deleteVariable = $_GET['Id'];
		$deleteMsg = "";
		
		if($deleteVariable == $deleteVariable)
		{
			$stmt = $conn->prepare("DELETE FROM pt_record WHERE soldier_id = '$deleteVariable'");
			$stmt->execute();
			$deleteMsg =  "Record Event Id Was Deleted: ".$deleteVariable;
		}
		else
		{
			$deleteMsg = "Record was not deleted!";
		}
	}
	?>
	<style type="text/css">
...
<body>
	...
	<div id="delete">
		<h1 class="color"><?php echo $deleteMsg; ?></h1>
		<h1>Pt Records</h1>
			<table
		<tr>
			<td class="top">ID</td>
