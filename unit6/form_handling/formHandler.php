...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inGender = $_POST["gender"];			//Get the value of what gender was selected
	$inContact = $_POST["contact"];			//Get what checkbox was selected
	$inProgram = $_POST["program"];			//Get what drop down was selected
...
<p>How to Contact: <?php echo $inContact; ?></p>
<p>Interested Program: <?php echo $inProgram; ?></p>
